...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard_avisos.index') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>AVISOS</span></a>
            </li>
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard_reportes.index') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>REPORTES DE FORMULARIO</span></a>
            </li>
            <hr class="sidebar-divider">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard_castellana_informes.index') }}">
                <i class="fas fa-fw fa-table"></i>
                    <span>INFORMES DE ACTIVIDADES</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard_castellana_reportes.index') }}">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard_lomas_II_informes.index') }}">
                <i class="fas fa-fw fa-chart-area"></i>
                    <span>INFORMES FINANCIEROS</span></a>
            </li>
...
<!-- Datatables -->
        <script src="{{ asset('js/DatatableCreateOrUpdate.js') }}"></script>
        @yield('javascript')
